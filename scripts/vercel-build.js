...
const productName = (pkg.build && pkg.build.productName) || pkg.productName || 'Bug Bounty IDE';
  ...
  <main>
    <section class="hero">
      <div class="wrap">
        ...
        <div class="cta-row">
          <a href="${GITHUB_RELEASES_LATEST}" class="btn btn-primary">
